...
1. [The object of study](#1-the-object-of-study) — TPG, the three traditions, Arnstein's ladder, the four framework dimensions
...
**Arnstein's ladder (1969)** — A classic eight-rung scale of citizen participation, from manipulation up to citizen control. This study borrows it as a **common analytic axis, not an evaluative scale**: the four framework dimensions derive from it, but the review is not ranking the traditions against each other.

**The four framework dimensions** — The axes on which both strands are compared: who participates; who benefits; what counts as social good and who decides; and what counts as relevant technology. *Note: the codebook and the registration currently disagree about the fourth — see the to-do list, Stage 0.*
...
- **Group 3 (judgment)** — C3, C4, C5, and the four framework dimensions. Both RAs code independently; lead adjudicates; AI codes blind.
