...
**Group definitions:** Group 1 = mechanical fields (enumeration, dedup, C1, C2, status, ecosystem role, partners, descriptive fields). Group 2 = self-label and non-lexicon description fields, including tier. Group 3 = judgment fields (C3, C4, C5, and the four framework dimensions).
...
| **Fix the four framework dimensions.** Registration says: who participates; who benefits; what counts as social good *and who decides*; what counts as relevant technology. Codebook instead splits good/decides and drops relevant technology | Decides which four; makes the literature strand's charting form match | — | None |
...
| Discuss disagreements; revise codebook and field wording where the instrument is at fault — especially the four dimensions | Leads revision, decides final wording | Contribute | None |
...
| Code the four framework dimensions | **Adjudicates every disagreement** | **Both code independently, every record** | **Role 3:** blind, withheld |
...
| Track saturation per block: six consecutively coded organizations with no new code on the four dimensions or ecosystem role | Confirms the count; only **adjudicated** new codes reset it | Track and report new codes | None |
...
| Compare organizational findings to literature findings on the four dimensions — structural, not distributional | **Jon's judgment throughout** | — | None |
